...
> SOLDUCK is a developer tool help organize scattered or premature documentation and clears out information gaps related to a standard Ethereum-based smart contract projects i.e. tokens, crowdsales, etc.
